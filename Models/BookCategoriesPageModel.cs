...
namespace Sfat_Adelina_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Sfat_Adelina_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Sfat_Adelina_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
